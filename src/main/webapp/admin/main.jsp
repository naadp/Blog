...
<script type="text/javascript">
    ...
    function reIndex(){
        $.messager.confirm("系统提示","您确定要重建索引吗?",function(r){
            if(r){


                <%-- 这里别忘了加.do后缀啊 --%>
                                $.post("${pageContext.request.contextPath}/admin/lucene/reIndex.do",{},function(result){
                                    if(result.success){
                                        $.messager.alert("系统提示","已成功将索引重建！");
                                    }else{
                                        $.messager.alert("系统提示","Sorry，重建失败咯！");
                                    }
                                },"json");
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<div title="系统管理"  data-options="iconCls:'icon-system'" style="padding:10px">
			...
			<a href="javascript:reIndex()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-refresh'" style="width: 150px;">索引重建</a>
		</div>
	</div>
</div>
<div region="south" style="height: 25px;padding: 5px" align="center">
	Copyright © 2017-2022 naadp 版权所有
</div>
